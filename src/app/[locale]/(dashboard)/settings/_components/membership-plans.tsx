...
const PlanCard = ({
  ...
  getLocaleName: (plan: MembershipPlan) => string;
  getLocaleDesc: (plan: MembershipPlan) => string;
            ...
            <div className="space-y-3">
              ...
              <div className="grid gap-3">
                {activePlans.map(plan => (
                  <PlanCard key={plan.id} plan={plan} isRTL={isRTL} t={t} getLocaleName={getLocaleName} getLocaleDesc={getLocaleDesc} getDurationLabel={getDurationLabel} />
                ))}
              </div>
            </div>
          )}
