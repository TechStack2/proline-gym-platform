  ...
  if (!open) {
    return (
      <button type="button" data-testid="desk-record-payment" onClick={() => setOpen(true)}
        className="mt-2 inline-flex items-center gap-1.5 rounded-lg bg-primary-700 px-2.5 py-1.5 text-xs font-semibold text-primary-foreground hover:bg-primary-800">
      ...
      <div className="grid grid-cols-2 gap-2">
        <label className="space-y-0.5 text-xs">
          ...
          <input data-testid="pay-amount-usd" type="number" step="0.01" min="0" value={amountUsd}
            ...
            className="w-full rounded-md border border-gray-200 px-2 py-1.5 text-sm focus:border-primary-700 focus:outline-none" />
        </label>
        <label className="space-y-0.5 text-xs">
      ...
      <div className="flex items-center justify-between">
        ...
        {!open && !done && (
          <button type="button" data-testid="desk-capture-lead" onClick={() => setOpen(true)}
            className="inline-flex items-center gap-1.5 rounded-lg bg-primary-700 px-2.5 py-1.5 text-xs font-semibold text-primary-foreground hover:bg-primary-800">
