      ...
      {showInstall && !isOffline && (
        ...
        >
          <div className="flex-shrink-0">
            <div className="flex items-center justify-center h-12 w-12 rounded-xl bg-primary-700 text-primary-foreground font-extrabold text-lg shadow-md">
              PL
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              className="rounded-lg bg-primary-700 px-4 py-2 text-xs font-medium text-primary-foreground hover:bg-primary-800 transition-colors shadow-sm"
            >
              {d.installButton}
            </button>
          </div>
