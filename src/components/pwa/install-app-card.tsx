    ...
    <div data-testid="install-app-card" data-can-prompt={canPrompt} dir={isRTL ? 'rtl' : 'ltr'}
      ...
      {canPrompt ? (
        ...
        <button type="button" data-testid="install-app-btn" onClick={() => void onInstall()}
          className="mt-3 inline-flex items-center gap-1.5 rounded-lg bg-primary-700 px-3 py-2 text-xs font-semibold text-primary-foreground hover:bg-primary-800">
