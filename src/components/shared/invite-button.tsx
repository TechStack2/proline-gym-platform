  ...
  return (
    <div className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm" data-testid="invite-result">
      ...
      <a href={waLink} target="_blank" rel="noopener noreferrer" data-testid="invite-wa-link"
        className="mt-2 inline-flex w-full items-center justify-center gap-1.5 rounded-xl bg-whatsapp px-4 py-2.5 text-sm font-semibold text-primary-foreground hover:bg-whatsapp-600">
