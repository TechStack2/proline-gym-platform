            ...
            >
              ...
              >
                ...
                {tab.badge !== undefined && tab.badge > 0 && (
                  <span className="absolute -top-1.5 -end-2 flex items-center justify-center min-w-[16px] h-[16px] px-1 rounded-full bg-primary-700 text-primary-foreground text-[10px] font-bold leading-none">
