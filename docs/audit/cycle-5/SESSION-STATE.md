...
- 🔵 **IA — journey-centric admin redesign (ACTIVE, jumped the queue 2026-06-11):** operator locked **IA-first** + **tenant-clean rule** (white-label SaaS direction — Proline = tenant #1). Audit + proposed 7-workspace IA: [`cohesion-audit-admin-ia.md`](./cohesion-audit-admin-ia.md) (Today · Inbox · Members/Member-360 · Schedule · Money · Team · Settings; 17 tabs → 7). Plan: operator approves IA → **IA-1** (nav + Inbox + Today + bell) → **IA-2** (Member-360 + Money merge) → resume punch-list.
